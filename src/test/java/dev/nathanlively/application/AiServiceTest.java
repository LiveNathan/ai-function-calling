...
class AiServiceTest {
    ...
    void sendMessageAndReceiveReplies_commCheck() {
        UserMessageDto userMessageDto = new UserMessageDto(timestampInstant, Instant.now(), "Nathan", "comm check", "chatId1", ZoneId.of("America/Chicago").toString(), "nathanlively@gmail.com");
    ...
    void sendMessageAndReceiveReplies_clockIn_returnsJson() {
        UserMessageDto userMessageDto = new UserMessageDto(timestampInstant, Instant.now(), "Nathan", "clock in to project A", "chatId1", ZoneId.of("America/Chicago").toString(), "nathanlively@gmail.com");
